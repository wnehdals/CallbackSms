...
//                downloadCallback);
    ...
    private String getContentLocation(Context context, Uri uri)
            throws MmsException {
        Cursor cursor = androidy.database.sqlite.SqliteWrapper.query(context, context.getContentResolver(),
    ...
    private static Long getId(Context context, String location) {
        ...
        Cursor c = androidy.database.sqlite.SqliteWrapper.query(
    ...
    private static void setErrorType(Context context, String locationUrl, int errorType) {
        ...
        try {
            if ((cursor.getCount() == 1) && cursor.moveToFirst()) {
                ...
                androidy.database.sqlite.SqliteWrapper.update(context, context.getContentResolver(),
