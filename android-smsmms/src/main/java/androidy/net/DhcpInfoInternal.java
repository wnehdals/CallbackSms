...
public class DhcpInfoInternal {
    ...
    private Collection<androidy.net.RouteInfo> mRoutes;

    public DhcpInfoInternal() {
        mRoutes = new ArrayList<androidy.net.RouteInfo>();
    }

    public void addRoute(androidy.net.RouteInfo routeInfo) {
    ...
    public androidy.net.LinkAddress makeLinkAddress() {
    ...
    public androidy.net.LinkProperties makeLinkProperties() {
        androidy.net.LinkProperties p = new LinkProperties();
    ...
    public void updateFromDhcpRequest(DhcpInfoInternal orig) {
        ...
        if (mRoutes.size() == 0) {
            for (androidy.net.RouteInfo route : orig.getRoutes()) {
                addRoute(route);
            }
        }
    }
