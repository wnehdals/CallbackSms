...
public class RouteInfo implements Parcelable {
     ...
     */
    private final androidy.net.LinkAddress mDestination;
    ...
    public RouteInfo(androidy.net.LinkAddress destination, InetAddress gateway) {
        if (destination == null) {
            if (gateway != null) {
                if (gateway instanceof Inet4Address) {
                    try {
                        destination = new androidy.net.LinkAddress(Inet4Address.getLocalHost(), 0);
                    ...
                    try {
                        destination = new androidy.net.LinkAddress(Inet6Address.getLocalHost(), 0);
                    } catch (UnknownHostException e) {
                        // TODO Auto-generated catch block
                        Log.e(TAG, "exception thrown", e);
                    }
        ...
        mDestination = new androidy.net.LinkAddress(NetworkUtilsHelper.getNetworkPart(destination.getAddress(),
    ...
    public static RouteInfo makeHostRoute(InetAddress host, InetAddress gateway) {
        ...
        if (host instanceof Inet4Address) {
            return new RouteInfo(new androidy.net.LinkAddress(host, 32), gateway);
        } else {
            return new RouteInfo(new androidy.net.LinkAddress(host, 128), gateway);
        }
    }
    ...
    public androidy.net.LinkAddress getDestination() {
        return mDestination;
    }
    ...
    public static final Creator<RouteInfo> CREATOR =
            new Creator<RouteInfo>() {
                public RouteInfo createFromParcel(Parcel in) {
                    ...
                    androidy.net.LinkAddress dest = null;
