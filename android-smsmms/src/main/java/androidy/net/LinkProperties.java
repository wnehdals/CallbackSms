...
public class LinkProperties implements Parcelable {
    ...
    String mIfaceName;
    private Collection<androidy.net.LinkAddress> mLinkAddresses = new ArrayList<androidy.net.LinkAddress>();
    private Collection<InetAddress> mDnses = new ArrayList<InetAddress>();
    private Collection<androidy.net.RouteInfo> mRoutes = new ArrayList<androidy.net.RouteInfo>();
    ...
    public LinkProperties(LinkProperties source) {
        if (source != null) {
            ...
            for (androidy.net.LinkAddress l : source.getLinkAddresses()) mLinkAddresses.add(l);
            for (InetAddress i : source.getDnses()) mDnses.add(i);
            for (androidy.net.RouteInfo r : source.getRoutes()) mRoutes.add(r);
    ...
    public Collection<InetAddress> getAddresses() {
        ...
        for (androidy.net.LinkAddress linkAddress : mLinkAddresses) {
            addresses.add(linkAddress.getAddress());
        }
        return Collections.unmodifiableCollection(addresses);
    }

    public void addLinkAddress(androidy.net.LinkAddress address) {
        if (address != null) mLinkAddresses.add(address);
    }

    public Collection<androidy.net.LinkAddress> getLinkAddresses() {
    ...
    public void addRoute(androidy.net.RouteInfo route) {
        if (route != null) mRoutes.add(route);
    }

    public Collection<androidy.net.RouteInfo> getRoutes() {
    ...
    public String toString() {
        ...
        for (androidy.net.LinkAddress addr : mLinkAddresses) linkAddresses += addr.toString() + ",";
        linkAddresses += "] ";
        ...
        for (androidy.net.RouteInfo route : mRoutes) routes += route.toString() + ",";
        routes += "] ";
    ...
    public boolean isIdenticalRoutes(LinkProperties target) {
        Collection<androidy.net.RouteInfo> targetRoutes = target.getRoutes();
     ...
     */
    public CompareResult<androidy.net.LinkAddress> compareAddresses(LinkProperties target) {
        /*
         ...
         * addedAddresses.
         */
        CompareResult<androidy.net.LinkAddress> result = new CompareResult<androidy.net.LinkAddress>();
        result.removed = new ArrayList<androidy.net.LinkAddress>(mLinkAddresses);
        result.added.clear();
        if (target != null) {
            for (androidy.net.LinkAddress newAddress : target.getLinkAddresses()) {
     ...
     * @return the removed and added lists.
     */
    public CompareResult<androidy.net.RouteInfo> compareRoutes(LinkProperties target) {
        /*
         ...
         */
        CompareResult<androidy.net.RouteInfo> result = new CompareResult<androidy.net.RouteInfo>();

        result.removed = new ArrayList<androidy.net.RouteInfo>(mRoutes);
        result.added.clear();
        if (target != null) {
            for (androidy.net.RouteInfo r : target.getRoutes()) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        for (androidy.net.RouteInfo route : mRoutes) {
