...
class MobileRepositoryImpl @Inject constructor(
    ...
    override suspend fun getPhoneContacts(): ArrayList<MobileEntity> {
        val contactsList = ArrayList<MobileEntity>()
        ...
        if (contactsCursor != null && contactsCursor.count > 0) {
            ...
            while (contactsCursor.moveToNext()) {
                ...
                if (name != null) {
                    contactsList.add(MobileEntity(id, name, mutableListOf()))
                }
            }
