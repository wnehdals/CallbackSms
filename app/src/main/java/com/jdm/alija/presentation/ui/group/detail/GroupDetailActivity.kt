        ...
        lifecycleScope.launch {
            repeatOnLifecycle(Lifecycle.State.STARTED) {
                groupDetailViewModel.viewState.collectLatest { state ->
                    binding.tvGroupDetailAppbarTitle.text = state.group.name
                    ...
                    binding.tvGroupDetailDayDesc.text = makeDayDescString(state.group.mon, state.group.tue, state.group.wed, state.group.thu, state.group.fri, state.group.sat, state.group.sun)
                }
            }
        }
    }
